...
module.exports.handleEvent = async function ({ api, event, Users }) {
  ...
  const responses = {
    "miss you": "অরেক বেডারে Miss না করে xan মেয়ে হলে বস 𝙈 𝙀 𝙃 𝙀 𝙍 𝘼 𝙅 রে হাঙ্গা করো😶👻😘",
    ...
    "owner": "‎[𝐎𝐖𝐍𝐄𝐑:☞ Meheraj Hossain ☜\nFacebook: https://www.facebook.com/junghoseog.2025",
    "admin": "He is 𝙈 𝙀 𝙃 𝙀 𝙍 𝘼 𝙅 তাকে সবাই  Bot Team Saport Admin হিসেবে চিনে😘☺️",
    ...
    "thanks": "এতো ধন্যবাদ না দিয়ে আমার বস 𝙈 𝙀 𝙃 𝙀 𝙍 𝘼 𝙅 রে তোর গার্লফ্রেন্ড টা দিয়ে দে..!🐸🥵",
    ...
    "tor nam ki": "MY NAME IS ─꯭─⃝‌‌𝙈 𝙀 𝙃 𝙀 𝙍 𝘼 𝙅 CHAT BOT💖",
    ...
    "love you": "ভালোবাসা নামক আবলামী করতে চাইলে Boss 𝙈 𝙀 𝙃 𝙀 𝙍 𝘼 𝙅 এর ইনবক্সে গুতা দিন 😘",
